...
const Dock = () => {
  ...
  useGSAP(() => {
    ...
    dock.addEventListener('mousemove', handleMouseMovements)
    dock.addEventListener('mouseleave', resetIcons)

    return () => {
      dock.removeEventListener('mousemove', handleMouseMovements)
  ...
  const toggleApp = (app) => {
    //Open Window Logic For Each Clicking of Buttons
